...
import { a as PutBlobResult, B as BlobCommandOptions } from './put-6f84b94d.js';
...
declare const put: (pathname: string, body: string | node_stream.Readable | Blob | ArrayBuffer | FormData | ReadableStream<any> | File, options?: ClientPutCommandOptions | undefined) => Promise<PutBlobResult>;
...
declare const upload: (pathname: string, body: string | node_stream.Readable | Blob | ArrayBuffer | FormData | ReadableStream<any> | File, options?: UploadOptions | undefined) => Promise<PutBlobResult>;
